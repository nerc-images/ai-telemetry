...
ALTER TABLE VirtualMachine ADD COLUMN IF NOT EXISTS hubResource text references Hub(hubResource);
ALTER TABLE VirtualMachine ADD COLUMN IF NOT EXISTS clusterName text;
ALTER TABLE VirtualMachine ADD COLUMN IF NOT EXISTS clusterResource text references Cluster(clusterResource);
