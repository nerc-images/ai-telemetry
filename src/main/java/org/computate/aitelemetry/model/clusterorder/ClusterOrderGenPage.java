...
public class ClusterOrderGenPage extends ClusterOrderGenPageGen<PageLayout> {
  ...
  protected void _varsFq(JsonObject vars) {
    ...
    for(String var : ClusterOrder.varsFqForClass()) {
      ...
      if(v != null) {
        ...
        while(mFq.find()) {
          String entityVar = ClusterOrder.searchVarClusterOrder(varIndexed);
  ...
  **/
  ...
  protected void _classAllName(Wrap<String> w) {
    w.o("all OpenShift cluster orders");
  }

  @Override
  protected void _pageUri(Wrap<String> w) {
    if("enUS".equals(lang))
      w.o("/en-us/search/cluster-order");
  }

  @Override
  protected void _apiUri(Wrap<String> w) {
    w.o("/en-us/api/cluster-order");
  }
